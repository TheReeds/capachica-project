      ...
      <div class="flex h-16 items-center justify-between bg-primary-900 px-4">
        ...
        <div class="h-[calc(100vh-4rem)] overflow-y-auto py-4 px-3">
          <ul class="space-y-2">
            ...
            <li class="mt-4 pt-4 border-t border-primary-700">
              <h3 class="px-4 text-sm font-semibold text-primary-200 uppercase">Usuarios y Acceso</h3>
            </li>
            <li>
              <a 
            ...
            <!-- Sección Turismo -->
            <li class="mt-4 pt-4 border-t border-primary-700">
              <h3 class="px-4 text-sm font-semibold text-primary-200 uppercase">Sistema de Turismo</h3>
            </li>
            <li>
              <a 
            ...
            <!-- Sección Usuario -->
            <li class="mt-4 pt-4 border-t border-primary-700">
              <h3 class="px-4 text-sm font-semibold text-primary-200 uppercase">Mi cuenta</h3>
            </li>
            <li>
              <a 
                routerLink="/profile" 
