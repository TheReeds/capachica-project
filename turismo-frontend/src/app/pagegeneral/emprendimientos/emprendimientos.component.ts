              ...
              <div class="relative container mx-auto px-4 text-center">
                ...
                <div class="max-w-2xl mx-auto">
                  <div class="relative">
                    ...
                    class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    <button
...
<section class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 mb-6">
      ...
      <button
        ...
        [class]="estadoFiltroActual() === 'todos' ?
          ...
          'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-emerald-100 dark:hover:bg-emerald-800 hover:text-emerald-600 dark:hover:text-emerald-400'"
        class="p-4 rounded-lg transition-all duration-300 text-center border-2 border-transparent hover:border-emerald-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
      >
    ...
    <div *ngIf="tieneFiltrosActivos()" class="mb-4 flex items-center justify-between bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-700">
      ...
      <button
        ...
        class="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200"
      >
    ...
    <div *ngIf="asociacionSeleccionada() && estadoFiltroActual() === 'asociacion'" class="bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 rounded-xl p-6 mb-6 border border-emerald-200 dark:border-emerald-700">
      <div class="flex items-start space-x-4">
        <img
          *ngIf="asociacionSeleccionada()!.imagen_url"
          [src]="asociacionSeleccionada()!.imagen_url"
          [alt]="asociacionSeleccionada()!.nombre"
          class="w-16 h-16 rounded-full object-cover flex-shrink-0 ring-4 ring-emerald-200 dark:ring-emerald-600"
        ...
        <div class="flex-grow">
          <div class="flex items-center justify-between mb-2">
            ...
            <div class="text-right">
              ...
              <p *ngIf="emprendimientosFiltrados().length !== contarEmprendimientosPorAsociacion(asociacionSeleccionada()!.id)"
                 class="text-xs text-emerald-500 dark:text-emerald-300">
          ...
          <p *ngIf="asociacionSeleccionada()!.descripcion"
             class="text-emerald-700 dark:text-emerald-300 text-sm mb-3 leading-relaxed">
    ...
    <div *ngIf="estadoFiltroActual() === 'independientes'" class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-6 mb-6 border border-blue-200 dark:border-blue-700">
      <div class="flex items-center space-x-4">
        <div class="w-16 h-16 bg-blue-500 dark:bg-blue-600 rounded-full flex items-center justify-center flex-shrink-0">
