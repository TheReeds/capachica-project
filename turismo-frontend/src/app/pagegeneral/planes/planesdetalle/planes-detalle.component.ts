                        ...
                        <div class="flex-shrink-0">
                          <div class="relative">
                            ...
                            <div class="w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg transform hover:scale-105 transition-all duration-300"
                              ...
                              <div class="text-center">
                                <svg *ngIf="i === 0" xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-white mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                                </svg>
                                <svg *ngIf="i === 1" xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-white mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z" />
                                </svg>
                                <svg *ngIf="i === 2" xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-white mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                                </svg>
                                <svg *ngIf="i >= 3" xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-white mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
