            ...
            <div class="space-y-8">
              ...
              <div *ngIf="plan() as p">
                <div *ngIf="p.imagenes_galeria_urls && p.imagenes_galeria_urls.length > 0" 
                    class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 overflow-hidden transition-colors duration-300">
                    <h3 class="text-xl font-bold text-blue-700 dark:text-blue-400 mb-4">Galería de Imágenes</h3>
                    <div class="grid grid-cols-2 gap-4">
                      <div *ngFor="let imagen of p.imagenes_galeria_urls" 
              ...
              <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 transition-colors duration-300">
                <h3 class="text-xl font-bold text-blue-700 dark:text-blue-400 mb-4">Organizador Principal</h3>
                <div *ngIf="plan()!.organizador_principal" class="space-y-3">
                  ...
                  <div class="flex items-center gap-3">
                    ...
                    <span class="text-gray-600 dark:text-gray-300">{{ plan()!.organizador_principal!.ubicacion }}</span>
                  </div>
                  <div *ngIf="plan()!.organizador_principal!.telefono" class="flex items-center gap-3">
                    ...
                    <span class="text-gray-600 dark:text-gray-300">{{ plan()!.organizador_principal!.telefono }}</span>
                  </div>
                </div>
              </div>

              <!-- Actividades por días -->
              <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8 overflow-hidden transition-colors duration-300" *ngIf="plan() as p">
                <h3 class="text-xl font-bold text-blue-700 dark:text-blue-400 mb-6">Itinerario del Plan</h3>
                ...
                <div class="space-y-6" *ngIf="p.dias && p.dias.length > 0">
                    ...
                    <h4 class="text-lg font-bold flex items-center gap-2"
                        [ngClass]="{
                            'text-amber-700 dark:text-amber-400': i % 4 === 0,
                            'text-blue-700 dark:text-blue-400': i % 4 === 1,
                            'text-green-700 dark:text-green-400': i % 4 === 2,
                            'text-purple-700 dark:text-purple-400': i % 4 === 3
                        }">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 mt-2">{{ dia.descripcion }}</p>
                    <div *ngIf="dia.hora_inicio || dia.hora_fin" class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        <span *ngIf="dia.hora_inicio">Inicio: {{ dia.hora_inicio }}</span>
                        <span *ngIf="dia.hora_fin"> - Fin: {{ dia.hora_fin }}</span>
                    </div>
                    <div *ngIf="dia.notas_adicionales" class="text-sm text-blue-600 dark:text-blue-400 mt-2 font-medium">
                        📝 {{ dia.notas_adicionales }}
                    </div>
                    </div>
                </div>

                <div *ngIf="!p.dias || p.dias.length === 0" class="text-gray-500 dark:text-gray-400 text-center py-8">
              ...
              <!-- Qué incluye -->
              <div *ngIf="plan()!.que_incluye" class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 transition-colors duration-300">
                <h3 class="text-2xl font-bold text-blue-700 dark:text-blue-400 mb-6 flex items-center gap-3">
                ...
                <div class="prose prose-lg dark:prose-invert">
                  <p class="text-gray-700 dark:text-gray-300 leading-relaxed">{{ plan()!.que_incluye }}</p>
                </div>
              </div>

              <!-- Requerimientos y qué llevar -->
              <div class="grid md:grid-cols-2 gap-6">
                <div *ngIf="plan()!.requerimientos" class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-lg p-6 transition-colors duration-300">
                  <h4 class="text-lg font-bold text-amber-800 dark:text-amber-400 mb-3 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.732-.833-2.464 0L4.35 16.5c-.77.833.192 2.5 1.732 2.5z" />
                    </svg>
                    Requerimientos
                  </h4>
                  <p class="text-amber-700 dark:text-amber-300">{{ plan()!.requerimientos }}</p>
                </div>
                
                <div *ngIf="plan()!.que_llevar" class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-6 transition-colors duration-300">
                  <h4 class="text-lg font-bold text-blue-800 dark:text-blue-400 mb-3 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                    </svg>
                    Qué llevar
                  </h4>
                  <p class="text-blue-700 dark:text-blue-300">{{ plan()!.que_llevar }}</p>
                </div>
              </div>
            </div>
      
            <!-- Formulario de inscripción -->
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8 transition-colors duration-300">
              
              <!-- Estado del plan -->
              <div *ngIf="plan()!.cupos_disponibles === 0" class="mb-6 p-4 bg-red-100 dark:bg-red-900/30 border border-red-400 dark:border-red-600 rounded-lg transition-colors duration-300">
                ...
                <p class="text-red-600 dark:text-red-400 text-sm mt-1">Este plan no tiene cupos disponibles en este momento.</p>
              </div>

              <!-- Información de precio y disponibilidad -->
              <div class="mb-6 p-6 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border border-amber-200 dark:border-amber-700 rounded-lg transition-colors duration-300">
                <div class="text-center">
                  <div class="text-3xl font-bold text-amber-700 dark:text-amber-400 mb-2">
                    S/ {{ plan()!.precio_total || 0 }}
                  </div>
                  ...
                  <div *ngIf="plan() as p">
                        <div *ngIf="p.cupos_disponibles !== undefined && p.cupos_disponibles > 0" 
                            class="text-sm text-green-600 dark:text-green-400 font-medium mt-2">
              ...
              <div *ngIf="plan()!.cupos_disponibles !== 0">
                ...
                <div *ngIf="!isLoggedIn()" class="mb-6 p-4 bg-blue-100 dark:bg-blue-900/30 border border-blue-400 dark:border-blue-600 rounded-lg transition-colors duration-300">
                  <div class="text-center">
                    <div class="flex items-center justify-center gap-2 text-blue-700 dark:text-blue-400 mb-3">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                      </svg>
                      <span class="font-semibold">Inicia sesión para inscribirte</span>
                    </div>
                    <p class="text-blue-600 dark:text-blue-400 text-sm mb-4">Necesitas una cuenta para poder inscribirte a este plan.</p>
                    <div class="space-x-3">
                      <button 
                        (click)="irALogin()"
                      ...
                      <button 
                        (click)="irARegistro()"
                        class="bg-white dark:bg-gray-700 text-blue-600 dark:text-blue-400 border border-blue-600 dark:border-blue-400 px-6 py-2 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors duration-300"
                      >
                        Registrarse
                      </button>
                    </div>
                ...
                <form *ngIf="isLoggedIn()" [formGroup]="inscripcionForm" (ngSubmit)="onSubmitInscripcion()">
                  ...
                  <h2 class="text-2xl font-bold mb-6 text-amber-600 dark:text-amber-400">Formulario de Inscripción</h2>
                  ...
                  <div class="mb-6">
                    ...
                    <div class="flex items-center border-2 border-amber-200 dark:border-amber-600 rounded-lg w-fit">
                      <button type="button" 
                              (click)="decrementParticipantes()"
                              class="px-3 py-2 text-amber-600 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-colors duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <input type="number" 
                             ...
                             class="w-16 text-center border-x-2 border-amber-200 dark:border-amber-600 bg-transparent text-gray-800 dark:text-gray-200 py-2 focus:outline-none">
                    ...
                    <div *ngIf="totalCalculado() > 0" class="mt-3 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg transition-colors duration-300">
                      <div class="text-green-800 dark:text-green-400 font-semibold">
                  ...
                  <div class="mb-6">
                    ...
                    <select formControlName="metodo_pago"
                            class="w-full px-3 py-2 border border-amber-200 dark:border-amber-600 dark:bg-gray-700 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 transition-colors duration-300">
                  ...
                  <div class="mb-6">
                    ...
                    <textarea formControlName="requerimientos_especiales"
                              ...
                              class="w-full px-3 py-2 border border-amber-200 dark:border-amber-600 dark:bg-gray-700 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 transition-colors duration-300"></textarea>
                  </div>
                  ...
                  <div class="flex justify-end mt-8 space-x-4">
                    <button type="button" 
                            (click)="volverALista()"
                            class="px-6 py-3 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-all duration-300 flex items-center gap-2">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
