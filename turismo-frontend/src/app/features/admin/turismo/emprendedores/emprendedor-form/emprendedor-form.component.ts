            ...
            <div class="p-6">
              ...
              @if (activeTab === 'informacion-basica') {
                <div class="space-y-6">
                  <!-- Información básica -->
                  <div>
                    <h2 class="text-lg font-medium text-gray-900 dark:text-white transition-colors duration-300">Información Básica</h2>
                    <div class="mt-4 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                      <!-- Nombre -->
                      <div class="sm:col-span-4">
                        <label for="nombre" class="block text-sm font-medium text-gray-700 dark:text-gray-300 transition-colors duration-300">Nombre del Emprendimiento</label>
                        <div class="mt-1">
                          <input
                            type="text"
                            id="nombre"
                        ...
                        @if (emprendedorForm.get('nombre')?.invalid && emprendedorForm.get('nombre')?.touched) {
                          <p class="mt-2 text-sm text-red-600 dark:text-red-400 transition-colors duration-300">El nombre es obligatorio</p>
                        }
                      </div>
                      ...
                      <div class="sm:col-span-2">
                        ...
                        @if (emprendedorForm.get('tipo_servicio')?.invalid && emprendedorForm.get('tipo_servicio')?.touched) {
                          <p class="mt-2 text-sm text-red-600 dark:text-red-400 transition-colors duration-300">El tipo de servicio es obligatorio</p>
                        }
                      </div>
                      ...
                      <div class="sm:col-span-6">
                        ...
                        @if (emprendedorForm.get('descripcion')?.invalid && emprendedorForm.get('descripcion')?.touched) {
                          <p class="mt-2 text-sm text-red-600 dark:text-red-400 transition-colors duration-300">La descripción es obligatoria</p>
                        }
                      </div>
                      ...
                      <div class="sm:col-span-3">
                        ...
                        @if (emprendedorForm.get('categoria')?.invalid && emprendedorForm.get('categoria')?.touched) {
                          <p class="mt-2 text-sm text-red-600 dark:text-red-400 transition-colors duration-300">La categoría es obligatoria</p>
                        }
                      </div>
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                      ...
                      <div class="sm:col-span-6">
                        ...
                        @if (emprendedorForm.get('ubicacion')?.invalid && emprendedorForm.get('ubicacion')?.touched) {
                          <p class="mt-2 text-sm text-red-600 dark:text-red-400 transition-colors duration-300">La ubicación es obligatoria</p>
                        }
                      </div>
                      ...
                      <div class="sm:col-span-3">
                        ...
                        @if (emprendedorForm.get('telefono')?.invalid && emprendedorForm.get('telefono')?.touched) {
                          <p class="mt-2 text-sm text-red-600 dark:text-red-400 transition-colors duration-300">El teléfono es obligatorio</p>
                        }
                      </div>
                      ...
                      <div class="sm:col-span-3">
                        ...
                        @if (emprendedorForm.get('email')?.invalid && emprendedorForm.get('email')?.touched) {
                          <p class="mt-2 text-sm text-red-600 dark:text-red-400 transition-colors duration-300">El email es obligatorio y debe ser válido</p>
                        }
                      </div>
